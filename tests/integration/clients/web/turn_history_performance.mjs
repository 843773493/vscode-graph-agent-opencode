...
const baseUrl = requiredEnvironment("BOXTEAM_INTEGRATION_BASE_URL");
const metricsPath = requiredEnvironment("BOXTEAM_INTEGRATION_METRICS_PATH");
const screenshotPath = requiredEnvironment("BOXTEAM_INTEGRATION_SCREENSHOT_PATH");
const localToken = requiredEnvironment("BOXTEAM_INTEGRATION_LOCAL_TOKEN");
const fixture = JSON.parse(requiredEnvironment("BOXTEAM_INTEGRATION_FIXTURE"));
