...
async def test_stopping_state_is_queryable_and_owner_stays_blocked_until_termination(
    ...
    monkeypatch.setattr(
        "app.services.infrastructure.node_debug_service._TERMINATE_TIMEOUT_SECONDS",
        60.0,
    )
    monkeypatch.setattr(
        "app.services.infrastructure.node_debug_service._KILL_TIMEOUT_SECONDS",
        60.0,
    )
...
async def test_reconcile_terminate_rechecks_identity_before_sigkilling(
    ...
    monkeypatch.setattr(
        "app.services.infrastructure.node_debug_service._RECONCILE_TERMINATE_TIMEOUT_SECONDS",
        0.05,
    )
